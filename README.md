...
```
$ docker run --rm -it --entrypoint "/bin/bash" esyoil-gmbh/puppeteer-api puppeteer fetch http://example.com | grep "h1"
<h1>Example Domain</h1>
```
...
```
$ docker run --rm -it --entrypoint "/bin/bash" esyoil-gmbh/puppeteer-api puppeteer scrape -s "h1" http://example.com
<h1>Example Domain</h1>
```
